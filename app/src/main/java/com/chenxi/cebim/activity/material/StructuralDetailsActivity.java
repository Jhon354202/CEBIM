...
public class StructuralDetailsActivity extends BaseActivity {

    @BindView(R.id.componentname)
    TextView componentname;
    @BindView(R.id.componentid)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_structural_details);
        ButterKnife.bind(this);
        Intent intent = getIntent();
        position = intent.getIntExtra("position", -1);
        componentname.setText(intent.getStringExtra("materialName"));
        componentid.setText(intent.getStringExtra("materialId"));
        currentstate.setText(intent.getStringExtra("previousstate"));
        nextstate.setText(intent.getStringExtra("nextstate"));
        savePath = DiskCacheDirUtil.getDiskCacheDir(StructuralDetailsActivity.this);//图片、视频、录音存储路径
        adapter = new ShowStructuralPicGridAdapter(StructuralDetailsActivity.this, tempPathList, pListener);
    ...
    private void showPicDialog() {
        picDialog = new Dialog(StructuralDetailsActivity.this, R.style.ActionSheetDialogStyle);
        View inflate = LayoutInflater.from(StructuralDetailsActivity.this).inflate(R.layout.pictureselect_dialog, null);
        ...
        getPhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PictureSelector.create(StructuralDetailsActivity.this)
