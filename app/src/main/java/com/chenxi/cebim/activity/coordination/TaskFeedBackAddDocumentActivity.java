...
import com.chenxi.cebim.adapter.TaskFeedBackAddDocumnetAdapter;
...
public class TaskFeedBackAddDocumentActivity extends BaseActivity {
    ...
    private TaskFeedBackAddDocumnetAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task_feed_back_add_document);
    ...
    private void initView() {
        swipeRefresh = findViewById(R.id.task_feedback_document_swip_refresh);
        ...
        recyclerView = findViewById(R.id.task_feedback_document_recyclerview);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        listIsNull = findViewById(R.id.rl_task_feedback_document_list_is_null);
        ...
        //底部确认按钮
        bottomSure = findViewById(R.id.tv_task_feedback_bottom_sure);
        ...
        bottomSure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EventBus.getDefault().post(new CommonEven("TaskFeedBackActivity附件字符串:"+adapter.getDocumentString()));
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (tempList.size() == 0 || tempList == null) {
                                ...
                                if (isRefresh == 0) {
                                    adapter = new TaskFeedBackAddDocumnetAdapter(MyApplication.getContext(), showList, projectID, documentFileString, from);
                                    adapter.isShowCheckBox(true);//显示选择框
                                    recyclerView.setAdapter(adapter);


                                    String str=adapter.getDocumentString();
                                    ...
                                    if (showList != null && showList.size() > 0 && adapter != null) {
                                        ...
                                        adapter = new TaskFeedBackAddDocumnetAdapter(TaskFeedBackAddDocumentActivity.this, showList, projectID, documentFileString, from);
                                        adapter.isShowCheckBox(true);//显示选择框
                                        recyclerView.addItemDecoration(new DividerItemDecoration(TaskFeedBackAddDocumentActivity.this, DividerItemDecoration.VERTICAL));
                                        recyclerView.setAdapter(adapter);
                                        if (swipeRefresh.isRefreshing()) {
                                            swipeRefresh.setRefreshing(false);
                                        }
