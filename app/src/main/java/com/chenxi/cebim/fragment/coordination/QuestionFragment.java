...
import com.chenxi.cebim.activity.coordination.NewQuestion;
import com.chenxi.cebim.activity.coordination.QuestionScreenActivity;
...
public class QuestionFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getActivity(), NewQuestion.class);
        ...
        screen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getActivity(),QuestionScreenActivity.class);
                intent.putExtra("position",mPosition);
                startActivity(intent);
            }
        });
        //实例化
        viewPager = (ViewPager) view.findViewById(R.id.question_viewpager);
        tabLayout = (TabLayout) view.findViewById(R.id.question_tablayout);

        QuestionUncompleteFragment questionUncompleteFragment = new QuestionUncompleteFragment();
        QuestionDelayFragment questionDelayFragment = new QuestionDelayFragment();
        QuestionCompletedFragment questionCompletedFragment = new QuestionCompletedFragment();

        list = new ArrayList<>();
        list.add(questionUncompleteFragment);
        list.add(questionDelayFragment);
        list.add(questionCompletedFragment);
        //ViewPager的适配器
        adapter = new QuestionFragmentAdapter(getActivity().getSupportFragmentManager(), list);
...
//                            questionList.add(questionModel);
    ...
    class QuestionFragmentAdapter extends FragmentStatePagerAdapter {
        ...
        public QuestionFragmentAdapter(FragmentManager fm, List<Fragment> fragmentList) {
            super(fm);
